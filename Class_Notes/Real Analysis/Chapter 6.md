...
> Given an interval $I = [a,b]$, a **partition of $I$** is an ordered set $P = \theset{x_0, x_1, \ldots, x_n}$ of finitely many points where $x_i \in [a,b]$ for all $0\leq i,j \leq n$ and $x_0 \leq x_1 \leq \cdots x_n$.
