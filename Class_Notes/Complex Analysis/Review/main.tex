...
\begin{enumerate}
    ...
    Every linear fractional transformation is determined by its action on three points. Given 3 pairs points $z_i \mapsto w_i$, construct an LFT using the implicit equation
    \[
