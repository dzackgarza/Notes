...
1. This is a consequence of the integral basis theorem.

2. Suppose \( \alpha \in K \) and is a root of a monic polynomial in $\ZZ_K[x]$, we then want to show \( \alpha\in \ZZ_K \).
:::
