...
contradiction that \({\mathrm{Orb}}(Q_1)\) does not contain \(Q_2\). We
may choose \(\alpha\in {\mathbb{Z}}_L\) such that
...
\(\beta = \prod_{\sigma \in G(L/K)} \sigma( \alpha) \in {\mathbb{Z}}_K\),
...
Using the previous efg theorem, \(\sum_{i=1}^g e_i f_i = n\), but by the
...
\begin{quote}
\href{https://q.uiver.app/?q=}{Link
to Diagram}
\end{quote}
