...
{\tiny \textit{Last updated:} 2021-05-23 }
\end{flushleft}
...
\operatorname{Log}(\varepsilon) = \sumn\_i
\operatorname{Log}(\varepsilon\_i) .{]} Hence
\begin{align*}
...
\hypertarget{section}{%
\section{\texorpdfstring{{\left[ {{ { \iota \theta^t }_1, { \iota \theta^t }_2, \cdots, { \iota \theta^t }_{n}} } \right]}}{}}\label{section}}

{\left[ {{ {\iota \omega^r}_1, {\iota \omega^r}_2, \cdots, {\iota \omega^r}_{n}}} \right]}A
.{]} Taking \({\left\lvert {\det{{-}}} \right\rvert}\) on both sides, we
get
\begin{align*}
