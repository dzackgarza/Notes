...
:::{.remark}
Set $B_p^{\infty } \da \union_{r\geq 1} B_p^r \subseteq Z_p^{\infty } \da \int_{s\geq 1} Z_p^s$, which follows from a set theory exercise.
:::
...
\[
{Z_p^{r+1} \over B_p^r} \cong { A_p^{r+1} + A_{p-1}^{r-1} \over {dA_{p+r-1}^{r-1} + A_{p-1}^{r-1} }
.\]
