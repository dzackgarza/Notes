...
Now for a fixed $A$, let

- $M_3 = A$, 
- $M_2$ be the first stage in projective resolution $P \mapsvia{\bd_0} A$, and
- $M_1 \da \ker \bd_0$.

This yields a SES:
\[
\xi: 0 \to \ker \bd_0 \to P \mapsvia{\bd_0}  A \to  0
,\]
and thus a LES of the above form.
Since $P$ is projective, it is $G\dash$acyclic for $G(\wait) \da F\op(\wait)$.
