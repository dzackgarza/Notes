...
Noting that $d^0(x) \da nx$ was multiplication by $n$, we have $\bd^0(f) = d^0 \circ f$ is post-composition by the multiplication by $n$ map, and $\tilde \bd^0$ similarly becomes multiplication by $n$.
