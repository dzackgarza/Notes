...
For pushouts, writing $X_i$ for the pushout of $A_i \mapsfrom P_i \mapsto B_i$, this gives an exact sequence of diagrams which in turn corresponds to an exact sequence of the pushout objects $X_i$:
...
However, the sequence of cokernels appearing on the right is not exact in general, since this precisely fits into the diagram used in the snake lemma:
...
\begin{tikzcd}
	...
	\\
	0 & {P_1} & {P_1} & {P_1} & 0 \\
	& {\coker f_1} & {\coker f_2} & {\coker f_3} & 0 \\
	& {} & {} & {} & {}
	...
	\arrow[color={rgb,255:red,92;green,214;blue,92}, from=1-4, to=5-2, in=180, out=0]
	\arrow[color={rgb,255:red,214;green,92;blue,92}, from=5-2, to=5-3]
	\arrow[from=5-3, to=5-4]
	\arrow[from=5-4, to=5-5]
\end{tikzcd}

> [Link to Diagram](https://q.uiver.app/?q=)
