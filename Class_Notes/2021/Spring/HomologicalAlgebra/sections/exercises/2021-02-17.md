...
- $b \implies c$
- $c\implies d$: 
  This is clear since if $\Ext^i$ all vanish for $i\geq 1$, then $\Ext^1$ vanishes.
- $d \implies b$
...
\[
L_iF(B') \cong L_{i-m-1}F(M_m) \iff L_{i+m+1}F(B') \cong L_iF(M_m)
.\]
...
For $m=0$, we can extract a SES 
\[
0 \to B' \mapsvia{\bd_{i-1}}  I_0 \to M_0 \da \ker \bd_{-1}
\]
and take the associated LES

\begin{tikzcd}
	0 \\
	{B'} && {I_0} && {M_0} \\
	\\
	{L_1F(B')} && \textcolor{rgb,255:red,214;green,92;blue,92}{L_1F(I_0)} && \textcolor{rgb,255:red,92;green,92;blue,214}{L_1F(M_0)} \\
	\\
	\textcolor{rgb,255:red,92;green,92;blue,214}{L_2F(B')} && \textcolor{rgb,255:red,214;green,92;blue,92}{L_2F(I_0)} && \textcolor{rgb,255:red,92;green,92;blue,214}{L_2F(M_0)} \\
	\\
	\textcolor{rgb,255:red,92;green,92;blue,214}{L_3F(B')} &&&& {}
	...
	\arrow["{\delta_0}", from=2-5, to=4-1]
	\arrow["{\delta_1}", color={rgb,255:red,92;green,92;blue,214}, from=4-5, to=6-1]
	\arrow["{\delta_2}", color={rgb,255:red,92;green,92;blue,214}, from=6-5, to=8-1]
\end{tikzcd}

> [Link to Diagram](https://q.uiver.app/?q=)

Note that by $F\dash$acyclicity, all of the red terms vanish, making the $\delta_i$ for $i>1$ isomorphisms.
By assumption $L_1F(M_0) = 0$, and so $L_2F(B') = 0$.
...
We'll use the dimension-shifting result from a previous exercise.

For general setup, let $\xi$ be a SES, then apply the covariant hom $F(\wait) \da \Hom_R(A, \wait)$ to $\xi$ to obtain an associated LES involving its right-derived functors.
After a relabeling, we can work in the opposite category and consider left-derived functors instead:

\begin{tikzcd}
	&&& {} \\
	{\xi:} & 0 & {M_1} & {M_2} & {M_3} & 0 \\
	\\
	{F\xi:} & \textcolor{rgb,255:red,92;green,92;blue,214}{0} & \textcolor{rgb,255:red,92;green,92;blue,214}{\Hom_R(A, M_1)} & \textcolor{rgb,255:red,92;green,92;blue,214}{\Hom_R(A, M_2)} & \textcolor{rgb,255:red,92;green,92;blue,214}{\Hom_R(A, M_3)} & {} \\
	\\
	&& \textcolor{rgb,255:red,214;green,92;blue,92}{\Ext_R^1(A, M_1)} & \textcolor{rgb,255:red,214;green,92;blue,92}{\Ext_R^1(A, M_2)} & \textcolor{rgb,255:red,214;green,92;blue,92}{\Ext_R^1(A, M_3)} \\
	\\
	&& {\Ext_R^2(A, M_1)} & \cdots
	\arrow[from=2-2, to=2-3]
	\arrow[""{name=0, anchor=center, inner sep=0}, "f", from=2-3, to=2-4]
	\arrow["g", from=2-4, to=2-5]
	\arrow[from=2-5, to=2-6]
	\arrow[color={rgb,255:red,92;green,92;blue,214}, from=4-2, to=4-3]
	\arrow[""{name=1, anchor=center, inner sep=0}, "{F(f)}", color={rgb,255:red,92;green,92;blue,214}, from=4-3, to=4-4]
	\arrow["{F(g)}", color={rgb,255:red,92;green,92;blue,214}, from=4-4, to=4-5]
	\arrow["{\delta_0}", from=4-5, to=6-3, in=180, out=0]
	\arrow["{L_1F(f)}", from=6-3, to=6-4]
	\arrow["{L_1F(g)}", from=6-4, to=6-5]
	\arrow["{\delta_1}", from=6-5, to=8-3, in=180, out=0]
	\arrow["{L_2F(f)}", from=8-3, to=8-4]
	\arrow["{\Hom_R(A, \wait)}", shorten <=4pt, shorten >=13pt, Rightarrow, from=0, to=1]
\end{tikzcd}

> [Link to Diagram](https://q.uiver.app/?q=)

Now for any fixed $B$, let

- $M_3 = B$, 
- $M_2$ be the first stage in projective resolution $P \mapsvia{\bd_0} B$, and
- $M_1 \da \ker \bd_0$.

This yields a SES:
\[
\xi: 0 \to \ker \bd_0 \to P \mapsvia{\bd_0}  B \to  0
,\]
and thus a LES of the above form.
Since $P$ is projective, it is $G\dash$acyclic for $G(\wait) \da F\op(\wait)$, and so there is a dimension-shifting isomorphism:
\[
L_iF(B) \cong L_{i-1}F(\ker \bd_0) \implies \Ext^i_R(A, B) \cong \Ext_R^{i-1}(A, \ker \bd_0)
.\]
We also have $L_iF(P) = \Ext
Now using our assumption that $\Ext_R^1(A, B)$ vanishes, we have
\[
