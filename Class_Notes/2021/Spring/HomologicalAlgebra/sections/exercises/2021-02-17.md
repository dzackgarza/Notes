...
Suppose $M$ is projective and $\xi$ is a SES, then apply $F(\wait) \da \Hom_R(\wait, M)$ to $\xi$ to obtain the associated LES

% https://q.uiver.app/?q=
\begin{tikzcd}
	0 & A & B & C & 0 \\
	\\
	0 & {\Hom_R(C, M)} & {\Hom_R(B, M)} & {\Hom_R(A, M)} & {\Ext^1_R(C, M)} & \cdots
	...
	\arrow[""{name=1, anchor=center, inner sep=0}, from=3-3, to=3-4]
	\arrow[from=3-4, to=3-5]
	\arrow[from=3-5, to=3-6]
	\arrow["{\Hom_R(\wait, M)}", shorten <=9pt, shorten >=9pt, Rightarrow, from=0, to=1]
\end{tikzcd}
