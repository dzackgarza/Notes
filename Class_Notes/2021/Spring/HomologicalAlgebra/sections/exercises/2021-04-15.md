...
Similarly, $\im(f)$ in $\liegmod$ is gotten by taking $\im_{\kmod}(f)$ and using that $\tilde f: M\to \im(f)$ is a restriction of the codomain and still a morphism of $\lieg\dash$modules.
