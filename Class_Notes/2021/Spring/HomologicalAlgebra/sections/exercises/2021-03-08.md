...
Start by applying the functor $X\tensor_R \wait$ to the above SES to obtain
...
\begin{tikzcd}
	...
	\\
	& {\Tor_1^R(X, A)} & {\Tor_1^R(X, B)} & {\Tor_1^R(X, C)} \\
	\\
	&&& \cdots
	\arrow[from=4-3, to=4-4]
	\arrow[from=4-4, to=3-4]
...
> [Link to Diagram](https://q.uiver.app/?q=)

Since $B$ and $C$ are flat, by the previous exercise, $\Tor_n^R(X, B) = \Tor_n^R(X, C) = 0$ for all $n\geq 1$.
