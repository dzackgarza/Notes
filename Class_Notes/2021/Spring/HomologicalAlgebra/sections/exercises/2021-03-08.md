...
\[
\varphi_i \in \Hom_{\cat A}(LF(i), X) 
\mapsvia{\text{induces}} 
\tilde \varphi_i \in \Hom_{\cat B}( F(i), RX) 
,\]
and by the universal property of $\hat{F}$, applying the adjunction isomorphism again yields
\[
