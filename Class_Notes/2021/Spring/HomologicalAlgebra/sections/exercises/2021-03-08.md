...
\]
is exact.
Note that $2\implies 3$ is immediate, and that $2\implies 1$ follows by applying $\wait \tensor_R B$ to a SES and taking the associated LES:
...
\begin{tikzcd}
	...
	\arrow["{\wait \tensor_R B}"{description, pos=0.3}, shorten <=5pt, shorten >=27pt, from=1-3, to=4-3]
\end{tikzcd}

> [Link to Diagram](https://q.uiver.app/?q=)
