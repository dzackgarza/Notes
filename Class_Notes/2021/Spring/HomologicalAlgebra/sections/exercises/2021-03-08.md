...
% https://q.uiver.app/?q=
\begin{tikzcd}
	{\cat{I}} \\
	\\
	i \\
	...
	\arrow["{\phi_i}", curve={height=-30pt}, from=3-1, to=4-6]
	\arrow["{\phi_j}"', curve={height=30pt}, from=5-1, to=4-6]
	\arrow["{\exists \psi_i}", color={rgb,255:red,51;green,109;blue,255}, dashed, from=3-1, to=4-3]
	\arrow["{\exists\psi_j}", color={rgb,255:red,51;green,109;blue,255}, dashed, from=5-1, to=4-3]
	\arrow["{\exists ! \eta_{ij}}", color={rgb,255:red,51;green,109;blue,255}, dashed, from=4-3, to=4-6]
\end{tikzcd}
:::
