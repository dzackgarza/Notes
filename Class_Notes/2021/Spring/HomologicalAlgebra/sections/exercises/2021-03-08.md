...
- We've applied the tensor-hom adjunction \( \rmod \mapstofrom \mods{\ZZ} \), 
...
To fix this, it seems like both results need to have a direct product taken over all $p$ and all $q$.
:::
