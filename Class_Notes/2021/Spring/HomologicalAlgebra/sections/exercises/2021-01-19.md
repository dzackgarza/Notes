...
1. $x\in \ker d_n^C \implies u_n(x) \in \ker d_n^D$, and
2. $y \in \im d_{n+1}^C \implies u_n(y) \in \im d_{n+1}^D$.

Since $u$ is a morphism of chain complexes, we have a commuting ladder:
