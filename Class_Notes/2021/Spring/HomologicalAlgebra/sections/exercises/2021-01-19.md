...
That the $\bd^f_n$ exist follows from the universal property of kernels in \( \mathcal{A}  \). 
...
Note that everything here commutes, and we can break the northeast corner of this diagram up:
