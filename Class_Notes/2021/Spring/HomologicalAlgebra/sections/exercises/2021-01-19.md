...
2. The complex $\ker f$ satisfies the universal property of kernels in $\Ch( \mathcal{A})$, i.e. if $K \mapsvia{g^k} A$ is a chain map, there is a unique chain map $u: K \to \ker f$ making the appropriate diagram commute.
