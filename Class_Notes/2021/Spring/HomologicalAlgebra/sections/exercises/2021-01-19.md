...
\begin{tikzcd}
	...
	\arrow["{\bd^f_{n+1}}"{description}, dotted, from=3-3, to=3-5]
	\arrow["{\bd^f_{n}}"{description}, dotted, from=3-5, to=3-7]
	...
	\arrow[from=1-7, to=1-9]
	\arrow["{g^K_{n+1}}"{description, pos=0.7}, color={rgb,255:red,87;green,219;blue,98}, curve={height=30pt}, from=1-3, to=5-3]
	\arrow["{g^K_{n}}"'{pos=0.7}, color={rgb,255:red,87;green,219;blue,98}, curve={height=30pt}, from=1-5, to=5-5]
	\arrow["{g^K_{n-1}}"'{pos=0.7}, color={rgb,255:red,87;green,219;blue,98}, curve={height=30pt}, from=1-7, to=5-7]
\end{tikzcd}
