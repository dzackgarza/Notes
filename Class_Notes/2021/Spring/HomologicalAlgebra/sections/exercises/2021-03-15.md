...
\[
(\Triv(B) \mapsvia{h} M) 
&\mapsto ( B \mapsvia{\Psi h} M^G) \\ \\
&\mapsto (A \mapsvia{f} B \mapsvia{\Psi h} M^G)
,\]
and now going right and down yields
\[
(\Triv(B) \mapsvia{h} M) 
&\mapsto (\Triv(A) \mapsvia{\Theta f} \Triv(B) \mapsvia{h} M) \\ \\
&\mapsto (A \mapsvia{\Psi \Theta f} B \mapsvia{\Psi h} M^G) \\ \\
&= (A \mapsvia{f} B \mapsvia{\Psi h} M^G)
.\]
