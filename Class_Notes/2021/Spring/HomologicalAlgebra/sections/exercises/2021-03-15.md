...
\[
0 = F_{-1}H_0(T) \subseteq F_0 H_0(T) = H_0(T) = F_1 H_0(T) = \cdots
,\]
i.e. there are no nontrivial terms.
This follows because the associated graded will be given by $\bigoplus_{p+q=0}E_{p, q}^\infty$, but this 
