...
% https://q.uiver.app/?q=
\begin{tikzcd}
	&&& {} \\
	&& {} & \vdots \\
	&&& {F_0H_2} \\
...
.\]
Noting that the first term is isomorphic to $E_{2, 0}^{\infty }$ by the analysis in degree 2 and the last is isomorphic to $E_{1, 0}^{\infty }$ by the analysis in degree 1, there is a sequence
\[
...
\mapsvia{d_{2, 0}^2} 
E_{0, 1}^2 
{\color{green} \surjects } E_{0, 1}^{\infty } {\color{green} \to} H_1 \to E_{1, 0}^{\infty } \to 0
.\]
...
- Exactness at the 1st term $E_{2, 0}^2$: this follows because in the composition of the two red maps above, $E_{2, 0}^{\infty }$ was isomorphic to the kernel of $d_{2, 0}^2$, which is the next map in the sequence. 
Since $H_2$ surjected onto this, we have image equals kernel.
- Exactness at the 2nd term $E_{0, 1}^2$: this follows because 
