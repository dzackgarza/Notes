...
.\]
Noting that the first term is isomorphic to $E_{2, 0}^{\infty }$ by the above remark, this yields a sequence
\[
E_{2, 0}^{\infty } \injects E_{2, 0}^2 \tp E_{0, 1}^2 \to E_{0, 1}^{\infty }
.\]
