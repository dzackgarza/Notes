...
% https://q.uiver.app/?q=
\begin{tikzcd}
	&&& {} \\
	0 && 0 && \vdots && \vdots && \vdots && \vdots && \udots \\
	&&&&&& {} \\
	&&&& {E^2_{0, 1}} && {E^2_{1, 1}} && \vdots && \vdots && \cdots \\
	\\
	&&&& \textcolor{rgb,255:red,60;green,116;blue,246}{E^2_{0, 0}} && \textcolor{rgb,255:red,60;green,116;blue,246}{E^2_{1, 0}} && {E^2_{2, 0}} && {E^2_{3, 0}} && \cdots \\
	& {} && {} &&&&&&& {} &&&& {} \\
	&&&&&&&&&&&& 0 && 0 \\
	&&& {}
	\arrow["{d_{3, 0}^2}"', color={rgb,255:red,23;green,186;blue,26}, from=6-11, to=4-7]
	\arrow["{d_{2, 0}^2}"', color={rgb,255:red,23;green,186;blue,26}, from=6-9, to=4-5]
	\arrow[dotted, from=8-13, to=6-9]
	\arrow[dotted, from=8-15, to=6-11]
	\arrow[dotted, from=4-5, to=2-1]
	\arrow[dotted, from=4-7, to=2-3]
	\arrow[dashed, no head, from=9-4, to=1-4]
	\arrow[dashed, no head, from=7-2, to=7-15]
\end{tikzcd}

Here the two blue terms have already stabilized since either the domain or codomain or the differentials at each spot is zero.
Tracking the two green maps and passing to $E^3$ yields

% https://q.uiver.app/?q=
\begin{tikzcd}
	\bullet \\
	&&& {} \\
	0 && 0 && \bullet && \vdots && \vdots && \vdots && \udots \\
	&&&&&& {} \\
	&&&& \textcolor{rgb,255:red,60;green,116;blue,246}{\coker(d_{2, 0}^2)} && \textcolor{rgb,255:red,60;green,116;blue,246}{\coker(d_{3, 0}^2)} && \vdots && \vdots && \cdots \\
	\\
	&&&& \textcolor{rgb,255:red,60;green,116;blue,246}{E^3_{0, 0} = E^2_{0, 0}} && \textcolor{rgb,255:red,60;green,116;blue,246}{E^3_{1, 0} = E^2_{1, 0}} && \textcolor{rgb,255:red,60;green,116;blue,246}{\ker(d_{2, 0}^2)} && {\ker(d_{3, 0}^2)} && \cdots \\
	& {} && {} &&&&&&& {} &&&& {} \\
	&&&&&&&&&&&& 0 && 0 \\
	&&& {} \\
	&&&&&&&&&&&&&& 0 && 0
	\arrow[dotted, from=5-5, to=3-1]
	\arrow[dashed, no head, from=10-4, to=2-4]
	\arrow[dashed, no head, from=8-2, to=8-15]
	\arrow["{d_{2, 0}^3}"', dotted, from=7-9, to=3-3]
	\arrow[dotted, from=5-7, to=1-1]
	\arrow["{d_{3, 0}^3}"', from=7-11, to=3-5]
	\arrow[dotted, tail reversed, no head, from=5-7, to=9-13]
	\arrow[dotted, from=11-15, to=7-9]
	\arrow[dotted, from=11-17, to=7-11]
\end{tikzcd}
:::
