...
\[
\adjunction{(\wait)_G}{\Triv}{\modsleft{G}}{\Ab}
.\]
...
:::{.claim}
Let $A/L$ be any $G\dash$trivial quotient, and consider the map
\[
{A\over L} &\mapsvia{f} {A \over R} \\
a_0 + L &\mapsto a_0 + R
.\]

This map is well-defined and injective, making $A/R$ the largest $G\dash$trivial quotient.
:::


:::{.proof title="?"}
To see that this is well-defined, let $a_0 + L = a_1 + L$ be two representatives of the same coset; we then want to show $f(a_0 + L) = f(a_1 + L)$.
Using $R\dash$linearity, this amounts to showing 
...
Using that $a_0 + L = a_1 + L \iff a_0 - a_1 \in L$, along with the fact that $g(a_0 + L) = a_0 + L$
