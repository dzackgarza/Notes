...
- Isomorphisms $E_{p, q}^{\infty } F_p H_{p +q} / F_{p-1} H_{p+q}$, or equivalently $E_{p, n-p}^{\infty } \cong F_p H_n / F_{p-1} H_n$, which are the $t-s$ **successive quotients** (or **sections**) of the filtration.
