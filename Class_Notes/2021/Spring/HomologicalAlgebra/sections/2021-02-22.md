...
\begin{tikzcd}
	...
	&& {}
	\arrow["{\epsilon \tensor \one}", from=3-4, to=3-2]
	\arrow["{\epsilon \tensor \one}", from=4-4, to=4-2]
	\arrow["{\epsilon \tensor \one}", from=5-4, to=5-2]
	\arrow["{\one \tensor \eta}"', from=5-4, to=7-4]
	\arrow["{\one \tensor \eta}"', from=5-6, to=7-6]
	\arrow["{\one \tensor \eta}"', from=5-8, to=7-8]
	\arrow[from=2-4, to=3-4]
	\arrow[from=3-6, to=3-4]
	\arrow[from=2-6, to=3-6]
	\arrow[from=2-8, to=3-8]
	\arrow[from=3-8, to=3-6]
	\arrow[from=4-8, to=4-6]
	...
	\arrow[color={rgb,255:red,214;green,92;blue,92}, dotted, no head, from=6-1, to=6-9]
	\arrow[color={rgb,255:red,214;green,92;blue,92}, dotted, no head, from=1-3, to=8-3]
	\arrow[from=5-10, to=5-8]
	\arrow[from=4-10, to=4-8]
	\arrow[from=3-10, to=3-8]
\end{tikzcd}

> [Link to Diagram](https://q.uiver.app/?q=)


We'll show there are two maps:
\[
A \tensor Q = \Tot(A\tensor Q) \mapsfrom_{\eps\tensor \one} \Tor(P\tensor Q) \mapsto_{1\tensor\eta} \Tor(P\tensor B) = P\tensor B
,\]
...
\[
L_*(A\tensor \wait) \mapsfrom_{\eps \tensor \one} H_*( \Tor (P\tensor Q) ) \mapsto_{\one \tensor \eta} L_*( \wait \tensor B)(A)
.\]
