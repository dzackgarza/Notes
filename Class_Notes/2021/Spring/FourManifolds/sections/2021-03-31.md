...
This would yield an isomorphism $\omega: T\dual \mapsvia{\sim} T$ which is alternating, in which case $\omega\inv: T \mapsvia{\sim} T\dual$ which is also alternating.
:::
