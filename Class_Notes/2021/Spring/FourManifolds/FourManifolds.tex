...
{\tiny \textit{Last updated:} 2021-02-08 }
\end{flushleft}
...
\tightlist
\item
  \(%  \textup{\uppercase{\romannumeral 1}}% _{p, q}
  \) is odd, unimodular, of signature \((p, q)\).
\item
  \(%  \textup{\uppercase{\romannumeral 2}}% _{p, q}
...
isomorphic to either \(%  \textup{\uppercase{\romannumeral 1}}% _{p, q}
\) or \(%  \textup{\uppercase{\romannumeral 2}}% _{p, q}
\) with \(8\divides p-q\).
