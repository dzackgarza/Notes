...
{\tiny \textit{Last updated:} 2021-04-01 }
\end{flushleft}
...
\(\ker(\mkern 1.5mu\overline{\mkern-1.5mu{\partial}\mkern-1.5mu}\mkern 1.5mu)/\operatorname{im}(\mkern 1.5mu\overline{\mkern-1.5mu{\partial}\mkern-1.5mu}\mkern 1.5mu) \cong { \mathscr{H} }( X; \Omega^p)\)
...
\(\dim_{\mathbb{C}}{ \mathscr{H} }^q(X; \Omega^p)\) doesn't depend on
