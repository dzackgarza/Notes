...
Any curve \(C\) of genus \(g\geq 2\) is of the form \(C = \H/ \Gamma\)
where \(\Gamma \leq \mathop{\mathrm{BiHol}}(\H)\) is a subgroup that
acts freely. By covering space theory, \(\Gamma = \pi_1(C)\), and it's
known that
\(\mathop{\mathrm{BiHol}}(\H) \cong {\operatorname{PSL}}_2({\mathbb{R}})\)
by the map
\begin{align*}
\begin{bmatrix}
a & b 
...
The upper half plane \(\H\) admits a \textbf{hyperbolic metric} which is
invariant under \({\operatorname{PSL}}_2({\mathbb{R}})\) given by
\begin{align*}
...
It's miraculous! The biholomorphisms of \(\H\) preserve a metric. So
\(C\) has a canonical metric, \(g_\text{hyp}\), which descends along the
quotient map \(\H \to \H/\Gamma \cong {\mathbb{C}}\).
