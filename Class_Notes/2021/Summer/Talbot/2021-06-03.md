...
:::{.lemma title="?"}
$\sol$ and $\psi$ can be made $E_2$.
:::

:::{.proof title="of lemma, in the case $\ell=1$"}
Consider $S^0[a_2] = S^0 \oplus S^2 \oplus S^4 \oplus \cdots = \Free_{E_1}(S^4)$.
...
\begin{tikzcd}
	...
	\arrow[dashed, from=5-1, to=1-5]
	\arrow[dashed, from=7-1, to=1-5]
\end{tikzcd}

> [Link to Diagram](https://q.uiver.app/?q=)
...
> [Link to Diagram](https://q.uiver.app/?q=)

- To build $\tau_{2p^n-2} k(n)$, one just needs to identify $Q_n \in \pi_0 \Hom(\FF_p, \Sigma^{2p^n - 1} \FF_p)$.
So one needs to identify $Q_n \in \pi_* \Hom(\FF_p, \FF_p)$, the $\mod p$ Steenrod algebra.
