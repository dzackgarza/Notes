...
Orthonormality simplifies projection matrices. Letting $S$ be the column space of $A$, where $A$ has columns consisting of  recall that the projection onto $S$ is defined by
$$
P_S = Q(Q^TQ)^{-1}Q^T,
$$
