...
An important property is that any choice of subspace $S\subseteq V$ yields a decomposition $V = S \oplus S^\perp$. Given two subspace $S_1$ and $S_2$ where $S_1^\perp = S_2$, we occasionally write $S_1 \perp S_2$.
