...
In words, at each stage, we take one of the original vectors, then subtract off its projections onto all of the $\vector u_i$ we've created up until that point.