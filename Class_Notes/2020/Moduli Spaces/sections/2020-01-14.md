...
*Proof:*
Let $F_\alpha \susbet F$ be an open cover, say each $F_\alpha$ is representable by $x_\alpha$.
...
\begin{align*}
F(x) \to \prod F(x_\alpha) \rightrightarrow \prod_{\alpha\beta} F(x_{\alpha\beta})
.\end{align*}
