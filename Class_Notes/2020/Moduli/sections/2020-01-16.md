...
Example:
The zero-dimensional subscemes $Z \in \PP^n_k$, then $P_Z$ is the length of $Z$, i.e. $\dim_k(\mathcal O_Z)$.
...
I.e. in flat families, it has to record how the tangent directions come togther.
