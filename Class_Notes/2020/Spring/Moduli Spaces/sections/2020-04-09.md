...
2. Generally, these diagrams can be completed (and thus the gluing maps are bijective) if the map , 
\[
\aut(X_{0}\injects X') \to \aut(X_{0} \injects X)
.\]
the automorphisms of $X'$ commuting with $X_{0} \injects X$ is surjective.
:::
