...
Since $M\in \OO$, we have $M = \bigoplus_{\lambda\in \lieh\dual}$ as a sum of weight spaces, and since the cosets partition $\lieh\dual$, we have $M = \bigoplus_{[\lambda_i] \in \lieh\dual/\Lambda} M_i$.
