...
:   Use the tensor identity
    ...
    Set $N_k$ to be the $U(\lieb)\generators{v_k, \cdots, v_n}$, which is a decreasing filtration since acting by $U(\lieb)$ moves along this list of vectors/weights to the right.
