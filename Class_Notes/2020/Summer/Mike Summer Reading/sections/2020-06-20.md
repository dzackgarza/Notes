...
Remark
: To show that two smooth structures are *distinct*, it suffices to show that they are not smoothly compatible.
...
Remark: There is only one 0-dimensional smooth manifold, up to equivalence of smooth 
