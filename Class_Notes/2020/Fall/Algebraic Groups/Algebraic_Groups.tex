...
{\tiny \textit{Last updated:} 2020-11-01 }
\end{flushleft}
...
\hypertarget{description-of-t_lambdamu-qtyhiwcdot-lambda}{%
\subsection{\texorpdfstring{Description of
\(T_\lambda^\mu \qty{H^i(w\cdot \lambda) }\)}{Description of T\_\textbackslash lambda\^{}\textbackslash mu \textbackslash qty\{H\^{}i(w\textbackslash cdot \textbackslash lambda) \}}}\label{description-of-t_lambdamu-qtyhiwcdot-lambda}}
...
\begin{center}\includesvg[width=0.7\linewidth]{97196c183d921c00a1a9e37a23ace5da8d804feb}\end{center}
...
\begin{center}\includesvg[width=0.7\linewidth]{8abc8a105328ad7558d47f968b822ef7c8d85228}\end{center}
...
:::\{.proposition title=``?''\} Let \(\lambda, \mu \in \bar{C}_\ZZ\) be
in the bottom alcove, where \(\mu \in \bar{F}_1\) but
\(\lambda\in F_1\). Let \(F\) be the facet containing \(w\cdot\lambda\),
then
\begin{align*}  
