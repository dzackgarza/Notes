...
- Obtained pregluing function $w_\rho$ from previous proof.

- $\mathcal{F}_\rho$ will be $F\circ \oldexp{w_\rho}$ expanded in the bases $Z_i$ from a trivialization of $TW$.
