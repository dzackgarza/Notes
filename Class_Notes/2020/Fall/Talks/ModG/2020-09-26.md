...
- So $\tilde A$ descends to a well-defined map on $\Sigma_2 \da \RR^2 / \ZZ^2$, which is still a linear self-homeomorphism

- There is a correspondence
\[  
\correspond{\text{Primitive vectors in }\ZZ^2}
\iff
\correspond{\text{Oriented simple closed curves}}
.\]
