...
- $\MCG_\Top(\RR^2) = 0$: for any $f:\RR^2\to \RR^2$, take the straight-line homotopy:
\[  
...
- $\MCG_\Top(\bar \DD^2) = 0$: for any $f: \bar\DD^2\to\bar\DD^2$ such that $\ro{f}{\bd \bar\DD^2} = \id$, take
\[  
