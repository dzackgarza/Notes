...
- If there exists some element with a given property, try to say where it comes from and why the property holds for it.
- Similarly, if a property holds for all elements of a set, try to say why.
