...
- Say what you're assuming at the start of the proof.
  ...
  - Examples: for $P\implies Q$,
    ...
    - Contradiction: "Suppose toward a contradiction $P$ but not $Q\cdots$" (usually show not $P$. If you show $Q$, a direct proof might be simpler.)
    - Contrapositive: "Suppose in the contrapositive that not $Q$ holds, $\cdots$"
