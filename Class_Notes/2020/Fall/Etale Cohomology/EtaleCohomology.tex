...
\addbibresource{/tmp/ci-pv0zfL7b9z/EtaleCohomology.bib}
...
{\tiny \textit{Last updated:} 2021-01-04 }
\end{flushleft}
...
\begin{definition}[Cohomological Brauer Group]\label{def:cohom_brauer_group}
