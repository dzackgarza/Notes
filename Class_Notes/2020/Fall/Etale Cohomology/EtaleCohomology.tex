...
bundle can be obtained from \(\OO_{U_i}^{\oplus n}\iun \qcoh(U_i)\). To
...
\(\spec L \tp \spec k\) is an étale cover. Descent data on this map is a
...
Thus \(n\tensors\tensor 1 - n\tensor 1\tensor s = 0\), putting this in
