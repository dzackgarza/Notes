...
$\dim (X) = 4$.
:::
Heuristic: there are three degrees of freedom in choosing the first row $x,y,z$, and to enforce the rank 1 condition, the second row must be a scalar multiple of the first, yielding one degree of freedom for the scalar.
