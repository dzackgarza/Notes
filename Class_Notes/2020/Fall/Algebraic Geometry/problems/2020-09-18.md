...
Let $\ts{I_j}_{j\leq n}$ be a maximal chain of length $n$ of closed irreducible subsets, so we have
\[  
\emptyset \subsetneq I_1 \subsetneq I_2 \subsetneq \cdots \subsetneq I_n
.\]
:::
