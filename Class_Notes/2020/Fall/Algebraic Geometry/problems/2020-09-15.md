...
Since $\ts{U_i} \covers X$, for each $i$ this would force one of $U_i \subset X_1$ or $U_i \subset X_2$, since otherwise $U_i \intersect X_1 \intersect X_2$ would be nonempty.
