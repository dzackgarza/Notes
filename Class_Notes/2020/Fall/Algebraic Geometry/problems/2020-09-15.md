...
Noting that $\pi_X^{-1}(x) \cong \ts{x}\cross Y \cong Y$, where we've assumed $Y$ to be irreducible.
and so by irreducibility we can conclude wlog that $\pi_X^{-1}(x) \intersect V = \emptyset$.
:::
