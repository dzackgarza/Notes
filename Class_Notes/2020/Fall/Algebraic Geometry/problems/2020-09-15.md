...
:::
This follows because if $U, V \subset X$ are open and disjoint then $X\sm U,\, X\sm V$ are closed disjoint, and we can write $X = \qty{X\sm U} \disjoint \qty{X\sm V}$ as a union of proper closed subsets.
