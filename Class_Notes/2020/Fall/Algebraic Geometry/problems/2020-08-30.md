...
by applying the Nullstellensatz and noting that (claim) $\gens{x_2, x_3}$ is radical.

We then have
\[  
I(X) &= I(X_1 \union X_2 \union X_3) \\
&= I(X_1) \intersect I(X_2) \intersect I(X_3) \\
&= IV(x_2 x_3) \intersect IV(x_1 x_3) \intersect IV(x_1 x_2) \\
&= \sqrt{IV(x_2x_3) + IV(x_1 x_3) + IV(x_1 x_2)} \\
&= \sqrt{IV(x_2x_3,\, x_1 x_3,\, x_1 x_2)} \hspace{8em}\text{since } \gens{a} + \gens{b} = \gens{a, b} \\
&= IV(x_2x_3,\, x_1 x_3,\, x_1 x_2) \\
&= \sqrt{\gens{x_2x_3,\, x_1 x_3,\, x_1 x_2}}
,\]
where in the last step we've used 
