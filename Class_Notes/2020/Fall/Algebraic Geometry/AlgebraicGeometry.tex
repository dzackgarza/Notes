...
{\tiny \textit{Last updated:} 2020-12-19 }
\end{flushleft}
...
Maximal ideals \$\mathfrak{m} = \textbackslash gens\{x\_1 - p\_1 & ,
\cdots, x\_n - p\_n\}\$ Points \(\tv{a_1, \cdots, a_n}\)\tabularnewline
...
\begin{proposition}[Hyperbolic inclusion of polynomial rings]\label{prop:inclusion_of_stuff}
...
\begin{definition}[Curves, Surfaces, and Hpyersurfaces]
