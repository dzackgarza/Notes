...
We want to show that the intersection step above also preserves strictness of inclusions.
...
Then $\bar a \neq 0$ in $R'/P'$, and there exists a monic polynomial of minimal degree that $\bar a$ satisfies, $p(x) = x^n + \sum_{i=2}^n \bar c_i x^i$.
This implies $\bar c_n \in Q'/P'$
