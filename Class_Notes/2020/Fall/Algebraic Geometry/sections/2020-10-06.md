...
In general, for schemes with $U \subset Y$ and $f^{-1} (U) \subset X$, we'll need some analog of $f^*: \OO_Y(U) \to \OO_X(f^{-1} (U) )$ to make sense of "composing" sections.
...
Morphisms of open subsets is again defined by morphisms of rings spaces
