...
The gluing construction gives $\PP^n$ the structure of a prevariety: we can consider $D(x_j) \subset \PP^n$ where each has the structure of a ringed space $(\AA^n, \OO_{\AA^n})$ and there are 
:::
