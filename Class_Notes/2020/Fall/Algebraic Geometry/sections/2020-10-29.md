...
In this case, there is a unique $\lambda(x_0, \cdots, x_n)$, namely $\lambda = 1/x_0$, such that each point in this set is of the form $\tv{1: {x_1\over x_0} : \cdots : {x_n \over x_0}}$, yielding a copy of $\AA^n\subset \PP^n$ 
:::
