...
![Image](figures/image_2020-12-01-10-01-58.png)
...
This is a different choice of affine embedding into $\AA^3$ which sends $(1,0,0) \to (0,0,0)$.
Taking the vanishing locus of linear parts, it suffices to take the linear parts of the generators, which yields $V(y, z) 
:::
