...
Every prevariety arises from the gluing construction applied to $X_i$ affine varieties, since a prevariety $(X, \OO_X)$ by definition has an open affine cover $X_i \covers X$.
