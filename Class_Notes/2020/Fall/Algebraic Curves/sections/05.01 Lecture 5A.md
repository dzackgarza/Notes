...
Since $k[t]$ is finitely generated as a $k\dash$algebra, this finiteness applies.
Thus $B$ is a finitely generated $A\dash$module, and since $v$ is $k[t]\dash$regular, it is also $A\dash$regular and thus $v = v_{\mathfrak{p}}$ for some $\mathfrak{p}\in \mspec(A)$.
