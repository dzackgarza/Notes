...
\left(y_{1}, \ldots, y_{2 n}\right) \longmapsto\left[\left(\frac{\partial}{\partial s}+J \frac{\partial}{\partial t}+\operatorname{grad} H_{t}\right)\left(\exp _{w_{\rho}} \sum y_{i} Z_{i}^{\rho}\right)\right]_{Z_{i}}
.\]
