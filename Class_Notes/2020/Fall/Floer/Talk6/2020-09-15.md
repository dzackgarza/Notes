...
- $\mathcal{M}(x, y)$, the moduli space of solutions to the Floer equation connection $x, y$.
  ...
  - Showed that after perturbing $H$, get a manifold of dimension $\mu(x) - \mu(y)$.

  - How did we do it: describe as zeros of a section of a vector bundle over $\mathcal{P}(x, y)$, apply Sard-Smale to show $\mathcal{M}(x, y)$ is the inverse image of a regular value of some map.
  - Needed tangent maps to be Fredholm operators, proved in 
