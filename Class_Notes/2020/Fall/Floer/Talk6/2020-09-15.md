...
- Maslov index: used the fact that $\Sp(2n, \RR)$ retracts onto $U(n)$ (use a polar decomposition $S = PQ$ as a PSD times orthogonal, then homotope $P$ to $I$) and $\pi_1 U_n = \ZZ$ (use $U(n) \simeq SU(n))
