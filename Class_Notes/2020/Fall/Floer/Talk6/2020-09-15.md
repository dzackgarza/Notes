...
.\]
  ...
  - Compactify by adding in *broken trajectories* to get $\bar{\mathcal{L}}(x, y)$.
...
Hats will generally denote maps factoring through the quotient.
:::
...
2. If $\ts{\ell_n}\subseteq \mathcal{L}(x, z)$ is a sequence such that
\[  
\ell_n \converges{n\to\infty}\too (\hat u, \hat v)
.\]
