...
10. Show that $H_*^{\text{Floer}}$ doesn't depend on $\mathcal{A}_H$ or $X_H$

11. Show $HF_* \cong HM_*^$, and compare dimensions of vector spaces occurring in the chain complexes.
