...
.\]
  ...
  - We'll then have
  \[  
  \bar{\mathcal{L}}(x, z) = \mathcal{L}(x, z) \union \bd \bar{\mathcal{L}}(x, z), \qquad \bd \bar{L}(x, z) = \bigcup_{\mu(y) = \mu(x) - 1} \mcl 
  .\]
  - Want to show $\mathcal{L}(x, y)$ is a compact $0\dash$manifold, proceed by showing $\bar{\mathcal{L}}(x, y)$ is a compact $1\dash$manifold with $\mathcal{L}(x, y)$ 
