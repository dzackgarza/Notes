...
- Maslov index: used the fact that 
  - Every path in $\gamma: I\to \Sp(2n, \RR)$ can be assigned an integer a map $\tilde \gamma: I \to S^1$ and taking (approximately) its winding number.
