...
Definition
: For $R$ a Noetherian ring, $\mfp \in \spec R$ is *regular* iff $\dim_{\RR_\mfp / pR_\mfp} {\mfp R_\mfp \over \qty{\mfp R_\mfp}^2} = \height(\mfp)$.
...
\begin{center}
\begin{tikzcd}
S \ar[r, "\subset"] \ar[d, line] & L \ar[d, line] \\
R \ar[r, "\subset"] & K
\end{tikzcd}
\end{center}
