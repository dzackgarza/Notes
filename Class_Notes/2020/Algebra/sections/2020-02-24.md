...
Fact: there is a complete classification of divisible (iff injective) $\ZZ\dash$modules:
...
Fact: any divisible $\ZZ\dash$module is isomorphic to a direct sum of copies of
