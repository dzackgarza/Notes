...
In case the above inequality does *not* hold, we can use an isotopy to change $\psi \to \psi'$ which induces a change $\xi \to \xi'$ in $f\inv[a, b]$ such that the integral curves of $\xi'$ induce $\psi'$.
