...
Example:
\begin{align*}
X = \AA^n_{\FF} &\implies \zeta_X(t) = {1 \over (1-q^{-t})(1-q^{1-t})} \\ 
.\end{align*}

Example:
\begin{align*}
X = \PP^n_{\FF} &\implies \zeta_X(t) = \qty{1 \over 1 - q^{-t}} \qty{1 \over 1 - q^{1-t}} \qty{1 \over 1 - q^{2-t}} \cdots \qty{1 \over q^{n-t}}   \\ 
.\end{align*}

Example:
\begin{align*}
X = \Gr_{\FF}_{k, n} &\implies \zeta_X(t) = ? \\ 
.\end{align*}
