...
Whenever $\theset{\Sigma_i}$ is transversely orientable, it can be associated uniquely to a nonsingular 1-form $\omega$, and we can study the set of critical points $S = \theset{}$
