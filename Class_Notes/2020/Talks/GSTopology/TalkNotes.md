...
Remark:
Contact manifolds are cylinder-like boundaries of symplectic manifolds; namely if $M$ is contact then we can pick any smooth function $f: \RR \to \RR^+$ and obtain an exact symplectic for $\omega = 
