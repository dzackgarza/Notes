...
::: {.remark}
Last time: we saw \( { \operatorname{Cl}} (V) \cong { \operatorname{Cl}} _0(V \oplus {\mathbb{R}}) \), and as a corollary,
\[
{ \operatorname{Cl}} _0({\mathbb{R}}^4) \cong { \operatorname{Cl}} ({\mathbb{R}}^3) = {\mathbb{H}}\oplus {\mathbb{H}}
.\]
Question from class: what's the motivation for studying the Clifford algebra in the first place? Rough answer, they give a nice way of studying orthogonal transformations in \( {\mathbb{R}}^n \).
:::

::: {.definition title="Pin"}
The group \( {\operatorname{Pin}}(V) \) is the subgroup of units of \( { \operatorname{Cl}} (V) \), which is generated by \( \left\{{ v\in V {~\mathrel{\Big|}~}{\left\lVert {v} \right\rVert} = 1 }\right\} \), so
\[
{\operatorname{Spin}}(V) \coloneqq{\operatorname{Pin}}(V) \cap{ \operatorname{Cl}} _0(V)
.\]
:::
...
There is a map
\[
V\hookrightarrow{ \operatorname{Cl}} (V) = {\mathbb{R}}\left\langle{ { {e_i}_1, {e_i}_2, \cdots, {e_i}_{k}}{~\mathrel{\Big|}~}i_1 \leq \cdots \leq i_k }\right\rangle  
,\]
so we can identify \( V \) with \( V^{\otimes 1} \) in the degree 1 piece of \( { \operatorname{Cl}} (V) \). In fact, \( V^{\otimes 1} \subseteq { \operatorname{Cl}} _1(V) \), the odd part, since writing \( { \operatorname{Cl}} (V) = \bigoplus_{i\geq 0} V^{\otimes i}/\cdots \), anything falling in an odd degree is in the odd part. If \( {\left\lVert {v} \right\rVert} = 1 \), we have \( v^2 =-1 \) and thus \( v(-v) = 1 \), so \( v\in { \operatorname{Cl}} (V)^{\times} \).
:::

::: {.question}
If \( v\in V \) with \( {\left\lVert {v} \right\rVert} = 1 \), is it true that \( v\in {\operatorname{Spin}}(V) \)?
:::

::: {.answer}
No, since \( V \subseteq { \operatorname{Cl}} (V) \) is in fact in \( { \operatorname{Cl}} _1(V) \).
:::

::: {.example title="?"}
What do elements of \( {\operatorname{Spin}}({\mathbb{R}}^2) \) look like? We can write
\[
{ \operatorname{Cl}} ({\mathbb{R}}^2) = {\mathbb{R}}\oplus {\mathbb{R}}e_1 \oplus {\mathbb{R}}e_2 \oplus {\mathbb{R}}e_1 e_2
,\]
and note that \( e_1, e_2 \in {\operatorname{Pin}}(V) \) if we take the \( e_i \) to be orthonormal. But similarly, \( \cos(\theta) e_1 + \sin(\theta) e_2 \in {\operatorname{Pin}}(V) \) for any \( \theta \in {\mathbb{R}}/2\pi {\mathbb{Z}} \). Also note that \( e_1e_1 \in {\operatorname{Pin}}(V) \cap{ \operatorname{Cl}} _0(V) \), and \( e_1 e_1 = -1 \in {\operatorname{Spin}}(V) \). What are some other elements? We can compute
\[
e_1 \qty{ \cos(\theta) e_1 + \sin(\theta) e_2) = -\cos(\theta) + \sin(\theta)e_1 e_2}
,\]
and so
\[
{\operatorname{Spin}}({\mathbb{R}}^2) = \left\{{ -\cos(\theta) + \sin(\theta)e_2 e_2 {~\mathrel{\Big|}~}\theta \in {\mathbb{R}}/2\pi {\mathbb{Z}}}\right\} 
.\]
:::

::: {.remark}
Notation: we'll write \( {\operatorname{Spin}}(n) \coloneqq{\operatorname{Spin}}({\mathbb{R}}^n) \).
:::

::: {.proposition title="?"}
\( {\operatorname{Spin}}(3) \cong {\operatorname{SU}}(2) \) as groups.
:::

::: {.proof title="?"}
We saw that \( { \operatorname{Cl}} _0({\mathbb{R}}^3) \cong { \operatorname{Cl}} ({\mathbb{R}}^2) \cong {\mathbb{H}} \), and so \( {\operatorname{Spin}}(3) \subseteq {\mathbb{H}}\cong { \operatorname{Cl}} _0({\mathbb{R}}^3) \) is the subset of the group of units. We have
\[
{ \operatorname{Cl}} _0({\mathbb{R}}^3) = {\mathbb{R}}\oplus {\mathbb{R}}e_1 e_2 \oplus {\mathbb{R}}e_1 e_3 \oplus {\mathbb{R}}e_2 e_1 \coloneqq{\mathbb{R}}1 \oplus {\mathbb{R}}i \oplus {\mathbb{R}}j \oplus {\mathbb{R}}k
,\]
and \( {\operatorname{Spin}}(3) \) is generated by all products \( vw \) where \( v, w\in {\mathbb{R}}^3 \) with \( {\left\lVert {v} \right\rVert} = {\left\lVert {w} \right\rVert} = 1 \). So vary over all \( w \) in the unit circle in \( {\mathbb{R}}e_1 \oplus {\mathbb{R}}x \) for \( x\in {\mathbb{R}}^3 \), then the product \( vw \) yields a 1-parameter subgroup of \( {\mathbb{H}}^{\times} \). First consider
\[
e_1 \qty{ {\mathbb{R}}e_1 \oplus {\mathbb{R}}x} = {\mathbb{R}}\left\langle{ -1 }\right\rangle  \oplus {\mathbb{R}}\left\langle{ e_1 x }\right\rangle = {\mathbb{R}}\oplus {\mathbb{R}}e_1 x \subset {\mathbb{H}}
.\]
Then \( {\operatorname{Spin}}(3) \) contains any 1-parameter subgroup of \( {\mathbb{H}}^{\times} \), which means \( S^1({\mathbb{H}}) \subseteq {\operatorname{Spin}}(3) \) (where \( S^1({\mathbb{H}}) \) are the unit norm elements). By changing basis, we may assume \( v= e_1 \), so this gives an equality.
:::

::: {.example title="?"}
\( {\operatorname{Spin}}(4) \cong {\operatorname{SU}}(2)^{\times 2} \).\
Note that
\[
{\operatorname{Spin}}(4) \subseteq { \operatorname{Cl}} _0({\mathbb{R}}^4) = { \operatorname{Cl}} ({\mathbb{R}}^3) = {\mathbb{H}}^{\oplus 2}
.\]
Fix a copy \( {\mathbb{R}}^3 \subseteq {\mathbb{R}}^4 \) (similar to how we fixed \( {\mathbb{R}}^2 \subseteq {\mathbb{R}}^3 \) above) to get an identification \( { \operatorname{Cl}} _0({\mathbb{R}}^4) \cong { \operatorname{Cl}} ({\mathbb{R}}^3) \).
...
We then have
\[
{ \operatorname{Cl}} _0({\mathbb{R}}^4) = { \operatorname{Cl}} ({\mathbb{R}}^3) \supseteq {\operatorname{Spin}}({\mathbb{R}}^3) \cong {\operatorname{SU}}(2) = S^1({\mathbb{H}})
.\]
The copy of \( {\mathbb{R}}^3 \) induces inclusions \( {\operatorname{Spin}}(3) \hookrightarrow{\operatorname{Spin}}(4) \), coming from \( S^1({\mathbb{H}}) \hookrightarrow{\mathbb{H}}\hookrightarrow{\mathbb{H}}^{\oplus 2} \). One needs to check that
\[
S^3 = {\operatorname{SU}}(2) = S^1({\mathbb{H}}^{\oplus 2})
,\]
and that these elements generate \( (S^3)^{\times 2} = ({\operatorname{SU}}(2))^{\times 2} \).

> Note that none of these inclusions are just inclusions into one factor.
:::

::: {.exercise title="?"}
Complete this computation. Easiest way: just use a basis and hack!
:::

::: {.proposition title="?"}
There is a homomorphism \( {\operatorname{Spin}}({\mathbb{R}}^n) \to {\operatorname{SO}}({\mathbb{R}}^n) \) with kernel \( {\mathbb{Z}}/2 \). If \( n\geq 3 \), then \( {\operatorname{Spin}}({\mathbb{R}}^n) \cong \overline{{\operatorname{SO}}({\mathbb{R}}^n)} \) is the universal cover.
:::

::: {.proof title="Sketch"}
Note that \( {\operatorname{Spin}}(V) \subseteq { \operatorname{Cl}} (V)^{\times} \) acts on \( { \operatorname{Cl}} (V) \) by conjugation:
\[
{\operatorname{Spin}}(V) &\mapsto \mathop{\mathrm{End}}_{{\mathsf{Vect}}_{/{\mathbb{R}}}} { \operatorname{Cl}} (V) \\
g&\mapsto ( x \mapsto gxg^{-1})
.\]
Looking at \( {\operatorname{Pin}}(V) \) is perhaps easier, since we have generators \( \left\{{ u {~\mathrel{\Big|}~}{\left\lVert {u} \right\rVert} = 1 }\right\} \). Noting that \( u^{-1}= -u \) by a previous computation, we can write \( uxu^{-1}= -uxu \), and we also have \( xu+ux = -2u\cdot x \), and so
\[
-uxu 
&= -u( -ux -2u\cdot x ) \\
&=-x + 2u(x\cdot u)
,\]
so note that if \( x\in V \subset { \operatorname{Cl}} _1(V) \), then the result \( -uxu \in V \subset { \operatorname{Cl}} _1(V) \) as well.

::: {.corollary title="?"}
The conjugation action by \( {\operatorname{Pin}}(V) \) preserves \( V = V^{\otimes 1} \subset {\operatorname{Spin}}(V) \). Question: what does the following map do geometrically?
\[
V &\to V \\
x &\mapsto -x + 2u(x\cdot u)
.\]
Writing this \( x\mapsto -R_u x \), here \( R_u \) is reflection in the plane orthogonal to \( u \). So there is a map
\[
{\operatorname{Pin}}(V) &\to O(V) \\
u &\mapsto -R_u 
,\]
and on \( {\operatorname{Spin}}(V) \), any two reflections preserve orientation, so
\[
u_1 u_2 \mapsto (-R_{u_1})(-R_{u_2}) = R_{u_1} R_{u_2} \in {\operatorname{SO}}(V)
,\]
and this yields a group homomorphism \( {\operatorname{Spin}}({\mathbb{R}}^n) \to {\operatorname{SO}}({\mathbb{R}}^n) \).
:::

::: {.remark}
Every element of \( {\operatorname{SO}}(V) \) is an even product of reflections, so \( {\operatorname{Spin}}(V) \twoheadrightarrow{\operatorname{SO}}(V) \).
:::

::: {.exercise title="?"}
As an exercise, check that \( {\mathcal{O}}({\mathbb{R}}^n) \) can be generated by reflections?

> Note, missed a part here.
:::

::: {.remark}
What is the kernel of this map? If for \( g\in {\operatorname{Spin}}(V) \) we have \( gxg^{-1}= x \) for all \( x\in V \subset { \operatorname{Cl}} (V) \), then \( g\in Z { \operatorname{Cl}} (V) \) is in the center. Moreover, one can check that for \( n \) odd, \( Z { \operatorname{Cl}} (V) = \pm\left\{{ 1, e_1, \cdots, e_n }\right\} \), and for \( n \) even \( Z{ \operatorname{Cl}} (V) = \pm\left\{{ 1 }\right\} \). In either case,
\[
Z { \operatorname{Cl}} (V) \cap{ \operatorname{Cl}} _0(V) = \left\{{ \pm 1 }\right\} \cong {\mathbb{Z}}/2
,\]
