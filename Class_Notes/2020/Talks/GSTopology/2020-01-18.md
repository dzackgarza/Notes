...
Let $(W, \lambda)$ be exact symplectic, so $(W, \omega = d\lambda)$ is symplectic.
The Liouville vector field on $(W, \omega)$ is the (unique) vector field $X$ such that $\iota_x d\lambda = \lambda$.
