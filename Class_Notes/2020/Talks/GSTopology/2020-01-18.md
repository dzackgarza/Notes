...
Equivalently, a 2-form $\omega$ such that $\omega^n \neq 0$ (c.f. Mike Hutchings).

> Motivation: There is Hamiltonian $H$ in the background, we want this to induce a vector field $V_H$ and thus a flow.
