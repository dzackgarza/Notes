...
> Note: $\bd(S^p\cross D^q) = S^p \cross S^{q-1} = \bd(D^p \cross S^{q-1})$
...
**Definition (Weinstein Surgery):**
We now add a $k\dash$handle along $\Lambda$ to yield some $W'$, where $\bd W'$ is obtained by surgery in $\bd W$ along $\Lambda$.  