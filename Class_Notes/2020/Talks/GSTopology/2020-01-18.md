...
Definition:
$W$ is a symplectic manifold iff $W$ is smooth of even dimension and admits a 2-form $\omega \in \Omega^2(W) = \Gamma^\infty(\wedge^2 T\dual W)$, i.e. a smooth section

\begin{align*}
\omega: TM \tensor TM \to \RR
\end{align*}

that is skew-symmetric (and here, implicitly bilinear).
