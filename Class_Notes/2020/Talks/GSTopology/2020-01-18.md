...
Definition:
$W$ is a symplectic manifold iff $W$ is smooth of even dimension and admits a closed, nondegenerate, skew-symmetric bilinear 2-form $\omega \in \Omega^2(W) = \Gamma^\infty(\wedge^2 T\dual W)$, i.e. a smooth section
