...
and produces a distinct manifold with the above properties which is obtained by surgery along $\Lambda$ an isotropic embedded sphere

$\Lambda$: An embedded $S^{k-1}$ such that $\restrictionof{\lambda}{\Lambda} = 0$.
