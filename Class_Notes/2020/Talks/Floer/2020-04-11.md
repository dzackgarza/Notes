...
> Note: I don't know what this pairing is. The top Chern class is the Euler class (obstructs nowhere zero sections) and are defined inductively: $c_1(E) = e(\Lambda^n(E)) \in H^2(E; \ZZ)$.
> 
> Assumption is satisfied when all maps $S^2 \to W$ lift to $B^3$ $\iff \pi_2(W) = 0$.

Thus we can trivialize 
