...
- $R(u)$ the set of regular points of $u$, i.e. $$(s_0, t_0) \in R(u) \subset \RR \cross S^1 \iff \forall s\neq s_0, u(s_0, t_0) \neq u(s, t_0)$$
...
- Use 8.6.1 to reduce 8.5.4 to two statements
  - The set of critical points of $v$ and $u$ are both discrete.
