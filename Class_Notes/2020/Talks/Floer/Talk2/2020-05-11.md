...
.\end{align*}
  ...
  - Attempt at explanation: chain rule
  \begin{align*}
  \qty{\psi_t \circ v}(s, t) = u(s, t) 
  &\implies \dd{\psi_t}{s}\qty{v(s, t)} \cdot \dd{v}{s}(s, t) = \dd{u}{s} \\
  &\implies \dd{\psi_t}{t}\qty{v(s, t)} \cdot \dd{v}{t}(s, t) = \dd{u}{t}
  .\end{align*}
