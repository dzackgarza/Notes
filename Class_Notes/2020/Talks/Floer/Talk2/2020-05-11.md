...
\begin{align*}
0 
&= \frac{\partial u}{\partial s}+J\left(\frac{\partial u}{\partial t}-X_{t}(u)\right) \quad\text{since $u$ is a solution} \\
&= {\color{blue} \dd{u}{s}} + J {\color{orange} \dd{u}{t}} - J X_t(u) \\
&= \qty{\color{blue} \qty{d\psi_t} \qty{\dd{v}{s}}  } + J \qty{\color{orange}\qty{d\psi_t} \qty{\dd{v}{t}} + X_t(u) } - J X_t(u) \quad\text{by substitution} \\
&= \left(d \psi_{t}\right)\left(\frac{\partial v}{\partial s}\right)+J(u)\left(d \psi_{t}\right)\left(\frac{\partial v}{\partial t}\right) \\
