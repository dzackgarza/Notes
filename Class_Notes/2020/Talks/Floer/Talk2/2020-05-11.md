...
.\end{align*}
If $(u, H) \in \mathcal{Z}(x, y)$ then the following map admits a continuous right-inverse and is surjective:
\begin{align*}
...
> Where $H = H_0 + h$ and $\mcf^H$ is the corresponding Floer operator
