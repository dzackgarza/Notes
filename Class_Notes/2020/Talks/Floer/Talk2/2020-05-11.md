...
- $X(t, u)$ is a vector field (time-dependent and periodic) on $\RR^{2n}$, $J$ an almost-complex structure, both smooth
...
\normalsize
- Prove 8.6.1 (direct, short) which transforms the Floer(?) equation
...
\begin{center}
\includegraphics[width = 0.5\textwidth]{figures/image_2020-05-13-18-45-19.png} 
\end{center}
\large
<!--digraph {-->
 <!--compound=true-->
