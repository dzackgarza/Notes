...
&= \qty{\color{blue} \qty{d\psi_t} \qty{\dd{v}{s}}  } + J \qty{\color{orange}\qty{d\psi_t} \qty{\dd{v}{t}} + X_t(u) } - J X_t(u) \\
&= \left(d \psi_{t}\right)\left(\frac{\partial v}{\partial s}\right)+J(u)\left(d \psi_{t}\right)\left(\frac{\partial v}{\partial s}\right) \\
