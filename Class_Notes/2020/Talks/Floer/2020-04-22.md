...
\begin{align*}
-\left\langle J(u)\left(d X_{t}\right)_{u}\left(Z_{i}\right), Z_{j}\right\rangle+\left\langle J(u)\left(d X_{t}\right)_{u}\left(Z_{j}\right), Z_{i}\right\rangle\right.& \\
\left.-\left\langle(d J)_{u}\left(\frac{\partial u}{\partial t}\right) Z_{i}, Z_{j}\right\rangle\right) &=0
.\end{align*}
