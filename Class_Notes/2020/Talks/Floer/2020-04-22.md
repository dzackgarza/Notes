...
Extend $\theset{Z_i}$ to a chart containing $p$ and use the Leibniz rule to write
\begin{align*}
&- \left\langle J\left(d X_{t}\right)\left(Z_{i}\right),\quad Z_{j}\right\rangle \\
&+ \left\langle J\left(d X_{t}\right)\left(Z_{j}\right), \quad Z_{i}\right\rangle \\
&+ \left\langle J\left(d Z_{i}\right)\left(X_{t}\right), \quad Z_{j}\right\rangle \\ 
&- \left\langle d\left(J Z_{i}\right)\left(X_{t}\right), \quad Z_{j}\right\rangle \\
&=\left\langle J\left[X_{t}, Z_{i}\right], \quad Z_{j}\right\rangle \\
&+ \left\langle J\left(d X_{t}\right)\left(Z_{j}\right), Z_{i}\right\rangle \\
&- \left\langle d\left(J Z_{i}\right)\left(X_{t}\right), Z_{j}\right\rangle
.\end{align*}
