...
&\left\langle J(u) \frac{\partial Z_{\color{red} i}}{\partial t}-J(u)\left(d X_{t}\right)_{u}\left(Z_{i}\right), Z_{j}\right\rangle \\
- &\left\langle J(u) \frac{\partial Z_{j}}{\partial t}-J(u)\left(d X_{t}\right)_{u} Z_{j}, ~~~Z_{i}\right\rangle=0
.\end{align*}
