...
&=\left\langle(d J)_{u}\left(\frac{\partial u}{\partial t}\right) Z_{i}, Z_{j}\right\rangle+\left\langle J(u) \frac{\partial Z_{i}}{\partial t}, Z_{j}\right\rangle+\left\langle J(u) Z_{i}, \frac{\partial Z_{j}}{\partial t}\right\rangle \\
&=\left\langle(d J)_{u}\left(\frac{\partial u}{\partial t}\right) Z_{i}, Z_{j}\right\rangle+\left\langle J(u) \frac{\partial Z_{i}}{\partial t}, Z_{j}\right\rangle-\left\langle Z_{i}, J(u) \frac{\partial Z_{j}}{\partial t}\right\rangle
.\end{align*}
