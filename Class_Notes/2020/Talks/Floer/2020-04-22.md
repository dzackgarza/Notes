...
\begin{align*}
0=d \omega\left(X_{t}, Z_{i}, Z_{j}\right) \\
=X_{t} \cdot \omega\left(Z_{i}, Z_{j}\right)-Z_{i} \cdot \omega\left(X_{t}, Z_{j}\right)+Z_{j} \cdot \omega\left(X_{t}, Z_{i}\right) \\
-\omega\left(\left[X_{t}, Z_{i}\right], Z_{j}\right)+\omega\left(\left[X_{t}, Z_{j}\right], Z_{i}\right)-\omega\left(\left[Z_{i}, Z_{j}\right], X_{t}\right) \\
...
-\left(d H_{t}\right)\left(\left[Z_{i}, Z_{j}\right]\right)-\omega\left(\left[X_{t}, Z_{i}\right], Z_{j}\right)+\omega\left(\left[X_{t}, Z_{j}\right], Z_{i}\right) \\
