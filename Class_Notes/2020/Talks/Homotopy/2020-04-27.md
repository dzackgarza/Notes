...
Important consequence: $\SO(3, \RR)$ is not simply connected! See "plate trick", there is a closed path of rotations that is nontrivial, but squares to the identity.
