...
Letting $\sigma \in K$ be arbitrary, noting that $[K: \QQ]$ is generated by the basis $\theset{1, \zeta, \zeta^2, \cdots, \zeta^{n-1}$, it suffices to specify $\sigma(\zeta)$ to fully determine the automorphism.
