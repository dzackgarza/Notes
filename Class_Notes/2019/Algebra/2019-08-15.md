...
Example:
$a + bi, a-bi$ are conjugate in $\CC/\RR$, since they both have minimal polynomial $x^2 - 2ax + (a^2 + b^2)$.

Definition: 
Two elements $\alpha \in F$ are *conjugate* if they have the same minimal polynomial.
