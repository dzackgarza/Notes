...
1. $[G, G]$ is a subgroup. Closure is clear from definition as generators. The identity is $e = e e\inv e e\inv$. So it suffices to show that $(aba\inv b\inv)\inv \in [G, G]$.
