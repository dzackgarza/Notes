...
Let $f \in \FF[x]$ with $f(\alpha) = 0$. Then $\alpha$ is a *multiple root* of $f'(\alpha) = 0$.
...
Consider $\Z_p \subseteq K \subseteq \overline{\ZZ}_p$ where $K$ is the set of zeros of $x^{p^n}-x$.
