...
which forces $K \cong E$ as vector spaces.

**Theorem**:
Every symmetric function can be written as some combination of sums and products of elementary symmetric functions.
