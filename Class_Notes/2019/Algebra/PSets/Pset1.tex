...
\begin{solution}
  Let
  $$\sigma = (s_1 s_2 \cdots s_r) \in S_n$$ in cycle notation, and $\tau \in S_n$ be arbitrary. Define $t_j = \tau(s_j)$; we would then like to show that $$(t_1, t_2, \cdots t_r) \coloneqq (\tau(s_1) \tau(s_2) \cdots \tau(s_r)) = \tau\sigma\tau\inv$$
