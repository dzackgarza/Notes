...
If we write $\bigoplus \ZZ/(r_i) = \ZZ^4/N$ where $N$ is the submodule generated by the prescribed relations, then we can construct a map $L: \ZZ^4 \to N$ which is given by the matrix
$$ A_L =
