...
*Example:* 
$S_{3}$ is the symmetries of a triangle (see notes).

*Example:* 
The symmetries of a square are *not* given by $S_{4}$, it is instead $D_{4}$ (see notes).
