...
Let $E\subseteq \RR^n$ be measurable. Then $f: E \to \RR \union \theset{\pm \infty}$ is *Lebesgue measurable* iff $f\inv((a, \infty])) \in \mathcal M$, the collection of Lebesgue measurable sets, for every $a\in\RR$.
