...
Thomae function: continuous on $\QQ$, but discontinuous on $\RR\setminus \QQ$. Can this be switched to get some $f$ that is continuous on $\RR\setminus \QQ$ and discontinuous on $\QQ$? The answer is no.
