...
Theorem:
Let $f$ be a bounded $\RR\dash$valued function on a closed interval $I = [a,b]$.
Then if $f$ is Riemann integrable, then $f \in L^1$ (so $\mathcal{R} \subseteq L^1$ is a subspace) and the integrals agree.
