...
So let $F_n = \theset{x \suchthat \omega_f(x) \geq 0}$. Let $I$ be an arbitrary closed interval and show there exists a subinterval $J \subseteq I$ with $J \subseteq F_n^c$.
