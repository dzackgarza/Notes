...
The pointwise limit of continuous functions has a meager set of discontinuities. If $f$ is integrable, the set of discontinuities is null. If $f$ is monotone, they are countable.
