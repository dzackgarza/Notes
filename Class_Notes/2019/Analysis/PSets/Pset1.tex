...
\begin{solution}\hfill
\begin{enumerate}
  \item To show the forward direction, suppose $X$ is a $G_\delta$, so $X = \union_{i\in\NN} A_i$ with each $A_i$ an open set. By definition, each $A_i^c$ is open, and we have
    $$
