...
\]
  ...
  Since $w \in \intersect_n V_n$, it is in $V_n$ for every $n$. But this means that there is some particular $x_0$ such that $w \in B_n(x)$ for every $n$ as well. Since $y\not\in X, y\neq x_0$, and so every neighborhood of $x_0$ contains a point $y\neq x_0$
