...
\[
  ...
  ,\end{align*}
\]
and note that $x_i < x_j$ forces $S(x_i) \subseteq S(x_j)$. In particular, it is worth noting that if $y\in S(x_i)$, for example, then $y = x_n$ for some $n$ where $f_n(x_i) = 1$.
