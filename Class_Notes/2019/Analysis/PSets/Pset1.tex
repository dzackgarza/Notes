...
\]
  ...
  We now want to take the limit as $\delta \to 0^+$; if we have $\delta_1 \leq \delta$ then $B_{\delta_1} \subseteq B_{\delta}$, so this can only make the left-hand-side of the above inequality smaller. We thus have so we have
  $$
