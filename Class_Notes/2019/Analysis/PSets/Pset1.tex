...
\begin{solution}\hfill\\
  \begin{enumerate}
    ...
    This evidently has no 1s in its ternary expansion, and if we sum the corresponding geometric series, we find $x = \frac 1 4$. This is not of the form $\frac k {3^n}$ for any $k, n$, and thus fulfills both conditions. $\qed$.

    This is evidently not of the form $\frac k {3^n}$ for any $k, n$. By summing the geometric series, we find that $x=\frac 1 4$, and has no 1s in its ternary expansion, and thus qualifies as an example.
  \end{enumerate}
\end{solution}
