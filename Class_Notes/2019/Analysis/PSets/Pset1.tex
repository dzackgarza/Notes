...
\begin{solution}
  To see that $g$ is continuous on $(0, \infty)$, let $x > 0$ be fixed and $\varepsilon$ be arbitrary. We'd like to produce a $\delta$ such that $\abs{x-y} < \delta \implies \sum \frac 1 {1+n^2 y} - \sum \frac 1 {1 + n^2 x} = \sum \frac {n^2(x-y)} {1 + n^2(x+y) + n^4xy} < \varepsilon$.
\end{solution}
