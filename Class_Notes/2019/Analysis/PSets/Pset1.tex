...
\]
  ...
  Since $w \in \intersect_n V_n$, it is in $V_n$ for every $n$. But this means that there is some particular $x_0$ such that $w \in B_n(x_0)$ for every $n$ as well. d$uuNoting that this means $B_n(x)$ is a neighborhood of $w$ for every $n$, since we assumed $w\not\in X$, we have $w \neq x_0$. But
