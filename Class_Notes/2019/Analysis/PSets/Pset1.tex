...
\begin{enumerate}
  \item We need to show that
    ...
    To that end, let $\varepsilon$ be fixed and $c \in I$ be arbitrary. If $c\in I\setminus\QQ$, then $f(c) = 0 < \varepsilon$ and there's nothing to prove. Otherwise, $c\in\QQ$
\end{enumerate}
\end{solution}
