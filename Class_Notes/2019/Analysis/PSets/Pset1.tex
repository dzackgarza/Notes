...
\]
  ...
  $$
  \RR \setminus \QQ = \RR \setminus \union_{q\in \QQ} \theset{q} = \intersect_{q\in\QQ} \RR - \theset{q},
  $$

  where we can note that $\RR-\theset{q}$ is an open, dense subset of $\RR$ for each $q$.
