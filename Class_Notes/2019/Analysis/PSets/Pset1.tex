...
\begin{enumerate}
  \item We need to show that
    ...
    To that end, let $\varepsilon$ be fixed and $c \in I$ be arbitrary. If $c\in I\setminus\QQ$, then $f(c) = 0 < \varepsilon$ and there's nothing to prove. Otherwise, $c\in\QQ$ and so $c = r_n$ for some $n$. Towards a contradiction, suppose th
\end{enumerate}
\end{solution}
