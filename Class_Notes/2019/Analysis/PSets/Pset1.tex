...
\]
  ...
  To see that $W \subseteq X$, let $y\in W$ be arbitrary. Since $y \in \intersect_n V_n$, it is in $V_n$ for every $n$. So pick one, say $n_0$, so $y\in V_{n_0}$. Then $y \in B_{n_0}(x)$ for some $x$
