...
\begin{solution}\hfill\\
  ...
  \item We first show that $C$ is nowhere dense by showing that the interior of its closure is empty, i.e. $(\overline C)^\circ = \emptyset$.
    ...
    By tracing through the construction of the Cantor set, we can deduce
    \begin{align*}
    \mu(C_1^c) = \frac 1 3 \\
    \mu(C_2^c) = \frac 1 3 + \frac 2 9 \\
    \cdots \\
    \mu(C_n^c) = \sum_{k=0}^n \frac {2^k} {3^{k+1}} = \frac 1 3
    \sum_{k=0}^n \frac {2^k} {3^{k}}
    .\end{align*}

    know that $\mu(C_n) = \left( \frac 2 3 \right)^n$, and so $\mu([0,1] \setminus C^n) = 1-\left( \frac 2 3 \right)^n$. Using the additivity of measure over disjoint sets, we have

    \begin{align*}
      \mu(C) &= 1 - \mu(C^c) \\
             &= 1 - \mu((\intersect_{n=1}^\infty C_n)^c) \\
             &= 1 - \mu(\disjoint_{n=1}^\infty C_n^c) \\
             &= 1 - \sum_{n=1}^\infty \mu(C_n^c) \\
             &= 1 - \sum_{n=1}^\infty 1 - \left( \frac 2 3 \right)^n \\
             &= \sum_n \left( \frac 2 3 \right)^n \\
             &=
    .\end{align*}
