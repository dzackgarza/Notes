...
\begin{solution}\hfill\\
  \begin{enumerate}
    ...
    $$
    Proof: Towards a contradiction suppose that $x\in C$ and contains a $1$ in its ternary expansion, so $a_k =1$ for some $k$. Without loss of generality, we can consider the smallest $k$ for which this happens.
