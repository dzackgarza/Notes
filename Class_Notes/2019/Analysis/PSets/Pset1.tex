...
\begin{enumerate}
  ...
  Since $x$ was arbitrary, we can do this for every $x\in I$ and thus produce a well-defined function $f$ where $f_n \to f$ pointwise. The claim is now that with this $f$, we can find $n$ large enough such that $d_\infty(f_n, f)< \varepsilon$.
