...
\]
  ...
  To see that $W \subseteq X$, let $w\in W$ be arbitrary. Since $w \in \intersect_n V_n$, it is in $V_n$ for every $n$. So pick one, say $n_0$, so $w\in V_{n_0}$. Then $w \in B_{n_0}(x)$ for some $x$
