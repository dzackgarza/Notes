...
\begin{solution}\hfill\\
  \begin{enumerate}
    ...
    So take $x = \frac 1 4$, which is demonstrably not of the form $\frac k {3^n}$, and has ternary expansion $x = (0.020202\cdots)_3 = (0.\overline{02})_3$.

    So take
    $$
    x = (0.\overline{02})_3 = (0.020202\cdots)_3 = \frac 1 4.
    $$

    This is evidently not of the form $\frac k {3^n}$ for any $k, n$, and has no 1s in its ternary expansion, and thus qualifies as an example.
  \end{enumerate}
\end{solution}
