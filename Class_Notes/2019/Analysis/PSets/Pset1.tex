...
\begin{enumerate}
  ...
  Since $S$ is a Cauchy sequence in the complete metric space $\RR$, it is convergent and thus has some limit that we will call $\lim_{n\to\infty} f_n(x) \coloneqq f(x)$.
