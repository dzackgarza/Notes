...
\]
  ...
  We now want to take the limit as $\delta \to 0^+$; again since $\delta_1 \leq \delta_2 \implies B_{\delta_1} \subseteq B_{\delta_2}$, this can only make the left-hand-side of the above inequality smaller, and so we have
