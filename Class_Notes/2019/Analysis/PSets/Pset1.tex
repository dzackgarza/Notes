...
\]
  ...
  which exhibits $X$ as a countable union of closed sets because $\QQ$ itself is countable. So $\QQ$ is an $F_\sigma$ set. If $\QQ$ were also a $G_\delta$, then this would force $\RR - \QQ$ to be an $F_\sigma$ set.
