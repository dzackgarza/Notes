...
\]
  ...
  Now letting $y\in B_{\delta_0}(x)$ be arbitrary, we can choose a new $\delta < \delta_0$ such that $B_\delta(y) \subset B_{\delta_0}(x)$. Since suprema can only get larger when taken over larger sets, we can write
  \[
  \begin{align*}
