...
\begin{solution}\hfill\\
  \begin{enumerate}
    ...
    Since the interval $(\frac 1 3, \frac 2 3)$ is deleted in $C_1$, we find that $a_1 = 1$ iff $x = \frac 1 3$.In this case, however, we claim that we can find a ternary expansion of $x$ that does not contain a $1$.  So we first define
    $$
