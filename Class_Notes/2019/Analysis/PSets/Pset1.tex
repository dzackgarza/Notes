...
\begin{problem}
  ...
  Prove and use the fact that $F_1 \superset F_2 \cdots$ is a nested sequence of closed, nonempty, bounded sets in a complete metric space with $\mathrm{diam} F_n  \to 0$ then $\intersect F_n = \theset{p}$ for some point $p$.
\end{problem}
