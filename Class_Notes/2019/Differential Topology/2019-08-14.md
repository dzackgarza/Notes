...
Supposing that $f: M^n \to M_l$ is a map, then locally there is a map $\tilde f: \RR^n \to \RR_l$. Moreover, we can write
$$
f(x_1, x_2, \cdots x_n) = \thevector{f_1(x_1, x_2, \cdots x_n), f_1(x_1, x_2, \cdots x_n), \cdots f_1(x_1, x_2, \cdots x_n)}
$$
