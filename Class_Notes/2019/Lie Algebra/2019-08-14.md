...
> The material for this class will roughly come from Humphrey, Chapters 1 to 5.
...
Around chapter 3 or 4, we will describe the following series of correspondences:

\begin{tikzcd}
\text{Semisimple algebras} \arrow[rr, Leftrightarrow]&  & \text{Root systems} \arrow[rr]&  & \text{Dynkin diagrams}\\
& &&  &\\
\text{Simple algebras over } \CC \arrow[rr] \arrow[uu, "\bigoplus"'] &  & \text{Irreducible root systems} \arrow[uu, "\coprod"'] \arrow[rr] &  & \text{Connected Dynkin diagrams} \arrow[uu, "\coprod"']
\end{tikzcd}
