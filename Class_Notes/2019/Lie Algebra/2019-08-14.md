...
We have $\lieg_u \mapsvia{\ad x} \lieg_{\mu + \alpha} \mapsvia{\ad x} \lieg_{\mu + 2\alpha} \to \cdots$,
and since $\lieg$ is finite dimensional, this must terminate, so $(\ad x)^n(y) = 0$ for some $n$.
