...
This means that $\kappa_{\ad \lieg}$ is non-degenerate, and thus $\ad \lieg \intersect (\ad \lieg)^\perp = 0$. (Note that the non-degeneracy of $\kappa$ already forces $(\ad \lieg)^\perp = 0$)
