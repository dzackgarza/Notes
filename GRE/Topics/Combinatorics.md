...
Inclusion-Exclusion: $$ \abs{\union_{i=1}^n A_i} = \sum_i \abs A_i - \sum_{i_1 < i_2} \abs{A_{i_1} \intersect A_{i_2}} + \sum_{i_1 < i_2 < i_3}\abs{A_{i_1} \intersect A_{i_2} \intersect A_{i_3}} + \cdots +(-1)^{n+1} \abs{\intersect_{i=1}^n A_i}$$
