...
\Entry
\href{http://www.retailscientifics.com/}
...
\begin{Detail}
\SubBulletItem
API development for real-time predictive modeling.
\end{Detail}
...
\begin{Detail}
\SubBulletItem
Built server-side OpenGL engine for rendering 3D models.
\end{Detail}
