...
$$
  ...
  $$
    ...
    Since the partial derivatives of $f$ exist and are continuous, $f$ is differentiable with derivative $f' = \nabla f$. Thus by the chain rule, $g$ is differentiable as well and can be compute as 
    $$
    \dd{}{t} g(t) = f'(\gamma(t))~\gamma'(t)
    $$ 
  $$\begin{align*}
  j
  \end{align*}$$