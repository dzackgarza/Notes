...
$$
    ...
    2. We want to compute $\min\theset{\inner{A\vector x}{\vector x}\suchthat \vector x \in S^2}$. I don't know how to do this from the given information, but this is equivalent to the operator norm, which is the largest singular value, which is the square root of the largest eigenvalues.    
