...
1. By the spectral theorem, $A$ is diagonalizable, and moreover by its matrix of eigenvectors. We can compute the characteristic polynomial
$$
p_\chi(x) = x^2 - (\Tr A)x + \det A = x^2 - 7x + 6 = (x=  
$$