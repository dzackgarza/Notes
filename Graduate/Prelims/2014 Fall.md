...
1. Parts
   1. $A$ is symmetric, so by the spectral theorem $A$ will be diagonalizable by its (orthogonal) matrix of eigenvectors. We can compute the characteristic polynomial
$$
