...
1. Parts
  ...
  $$
   ...
   $$
   where $\vector x\in S^2 \implies P^T\vector x \definedas \vector y \in S^2$ since $P^T$ is both orthogonal (so $P^T \vector x \in S^2)$ and full-rank (and thus a bijection $S^2 \selfmap$).
