...
1. $A = \left[ \begin{array} { r r r } { 1 } & { - 2 } & { 1 } \\ { 0 } & { 5 } & { - 3 } \\ { 0 } & { 0 } & { 0 } \end{array} \right]$; a straightforward computation of $\mathrm{nullspace}(A)$ shows that $\ker A = \mathrm{span}(\thevector{1,3,5})$.
