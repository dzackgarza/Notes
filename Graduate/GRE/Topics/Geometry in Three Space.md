...
$$
  - Example use: given $\vector{v}$, the rotated vector $\vector{R}_\frac{\pi}{2}\vector v \perp \vector v$, so useful to obtain normal vec or other perpendicular vectors in the plane.
