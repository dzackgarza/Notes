...
$$
  - Example use: given $\vector{v}$, the rotated vector $\vector{R}_\frac{\pi}{2}\vector v \perp \vector v$, so useful to obtain normal or other orthogonal vectors in the plane.
