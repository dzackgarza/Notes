...
2014 -- Present
\Gap
Calculus, Linear Algebra, Differential Equations, Real Analysis, Abstract Algebra, Complex Analysis
...
\begin{Detail}
\SubBulletItem
Server-side OpenGL engine development for rendering 3D models.
\end{Detail}
