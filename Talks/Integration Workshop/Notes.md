...
Before proceeding, note that we can factor and write $\frac{1}{z^6+1} = \frac{1}{\prod_k (z-\zeta_k)}​$. Moreover, we can isolate any given root as a denominator and this as
$$
