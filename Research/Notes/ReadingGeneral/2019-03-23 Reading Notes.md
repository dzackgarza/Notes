...
Our first guess is motivated by the hypothesis that a contravariant functor $E$ : (Schemes) → (Spectra) A weak equivalence of schemes $X \to Y$ would be expected to have the property
