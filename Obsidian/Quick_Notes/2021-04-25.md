...
Description of a certain wrapped [../Unsorted/Fukaya category](../Unsorted/Fukaya%20category.md) $\OO$: take the objects to be (Lagrangian) embedded curves, the morphisms are the graded abelian groups $\hom_\OO \definedas \qty{\bigoplus_{L_0 \transverse L_1} \ZZ/2\ZZ, \bd}$ wher $\bd$ is given by counting holomorphic strips, localize along small isotopies.
...
The most interesting commutative algebras are $S/I$ where $S = k[x_1, \cdots, x_n]$ for $k$ a field, $\ZZ$, or the [../Unsorted/localization](../Unsorted/localization.md) of a ring at a prime ideal.
...
- Bounding ranks of curves over a [../Unsorted/Function field](../Unsorted/Function%20field.md): see [elliptic fibrations](elliptic%20fibrations)
- [../Unsorted/Burnside ring (algebraic geometry)](../Unsorted/Burnside%20ring%20(algebraic%20geometry).md) in AG: 
...
- [modular forms](../Unsorted/modular%20form.md) yield 2-dimensional [Galois representations](Galois%20representations), and there is a classification theorem:
...
- The [representation ring](representation%20ring) $R(G)$: the free \(\ZZ\dash\)module on isomorphism classes of irreducible [representations](../Unsorted/Representation%20theory.md).

  - How can we construct this using modern [../Unsorted/groupoid](../Unsorted/groupoid.md) yoga? 
  ...
  Take its [../Unsorted/nerve](../Unsorted/nerve.md) and then the [../Unsorted/geometric realization](../Unsorted/geometric%20realization.md) and then $\pi_0$ or something?
  And then take the free \(\ZZ\dash\)module.
  I definitely need to ask some homotopy theorists how this construction goes for usual [../Unsorted/K-Theory](../Unsorted/K-Theory.md) in modern terms.
  So like...
  \[
  ...
  So maybe this needs to be something more [simplicial](../Unsorted/simplicial%20set.md).