...
The most interesting commutative algebras are $S/I$ where $S = k[x_1, \cdots, x_n]$ for $k$ a field, $\ZZ$, or the [localization](localization) of a ring at a prime ideal.
...
- [../zettelkasten/Burnside ring (algebraic geometry)](../zettelkasten/Burnside%20ring%20(algebraic%20geometry).md) in AG: 
