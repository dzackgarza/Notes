...
- See [[Atiyah duality]]: define the dual of $M$ as $M^{-\T M}$, the [[../Unsorted/Thom space]] of (minus) the tangent bundle.
...
- Use hocolims to glue spaces, but may not work in schemes.
  ...
  - Problem: this quotient isn't a [[../Unsorted/scheme]].
...
- [[../Unsorted/Grothendieck-Witt]] group: formal differences of isomorphism classes of nondegenerate symmetric bilinear forms.
...
- See [[rank]], [[../Unsorted/signature]], [[discriminant]] of forms.
...
- [../Unsorted/Factorization homology](../Unsorted/Factorization%20homology.md) setup:
...
- See [[../Unsorted/Day convolution]] as an example of a monoidal product.
...
- Axiomatic approach to factorization homology: take a left [[../Unsorted/Kan extension]] of the following:
![image_2021-05-10-17-05-53](figures/image_2021-05-10-17-05-53.png)

  - Can compute [Kan extension](../Unsorted/Kan%20extension.md) via the [bar construction](bar%20construction).

- Theorem: [../Unsorted/equivariant](../Unsorted/equivariant.md) [../Unsorted/nonabelian Poincaré duality](../Unsorted/nonabelian%20Poincaré%20duality.md):
...
- [[../Unsorted/Thom spectrum]] functor:
