...
- [Moduli space](../Unsorted/moduli%20space.md) of [stable maps](stable%20maps)
...
- Appearance of [Calabi-Yau](../Unsorted/Calabi-Yau.md) in [Physics](../Unsorted/Physics.md)
	- Related: [String theory](String%20theory), [Mirror Symmetry](../Unsorted/Mirror%20Symmetry.md)
...
- Pithy explanation of a [derived scheme](derived%20scheme): a space which can be covered by Zariski opens $Y\cong \spec A^*$ where $A\in \cdga_{k}$.
  ...
  - [Schemes](Schemes) and [2021-04-26_Stacks](../Unsorted/stack.md) can be very singular. 
...
- Derived modular stacks of [coherent sheaves](coherent%20sheaves) over $X$ remember the entire [../Unsorted/deformation theory](../Unsorted/deformation%20theory.md) of sheaves on $X$.
