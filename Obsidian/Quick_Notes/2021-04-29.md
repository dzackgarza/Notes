...
- Theorem and consequence of Quillen-Lichten: $K_{4i-2}(\ZZ) \tensor \ZZ_p \cong H^2_{\et}( \ZZ \invert{p}, \ZZ_p(2i))$.
  ...
  - Interpretation of [../Unsorted/local system](../Unsorted/local%20system.md)  and etale sheaf 

- This sheaf: $\ZZ_p(1) \da \underset{n}{\directlim}\, \mu_{p^n}$ and $\ZZ_p(i) \da \ZZ_p(1)^{\tensor i}$.

- [Étale Homotopy](../Unsorted/Étale%20homotopy.md) of $\OO_K$ for $K$ a [../Unsorted/Global field](../Unsorted/Global%20field.md): a punctured 3-manifold
...
- [Langlands](../Unsorted/Langlands.md) philosophy: all Galois representations are accounted for by the cohomology of [arithmetic groups](arithmetic%20groups)
...
- [../Unsorted/classifying space](../Unsorted/classifying%20space.md) of a category: [../Unsorted/geometric realization](../Unsorted/geometric%20realization.md) of the [../Unsorted/nerve](../Unsorted/nerve.md).

- Constructing [../Unsorted/K-Theory](../Unsorted/K-Theory.md):
...
- Hodge map: came from taking the [Hodge bundle](Hodge%20bundle) and its [Chern classes](../Unsorted/Chern%20class.md), where the fiber over every $A\in \Ag$ is $H^0(A, \Omega_A^1)$ the [Hodge cohomology](Hodge%20cohomology)
...
- [../Unsorted/Tilting](../Unsorted/Tilting.md): pass from mixed characteristic to characteristic $p$.
  Try to use simpler proofs/theorems from characteristic $p$ situation.

  - Going forward: some limiting process after inverting $p$..?
    Going backward: take [../Unsorted/Witt Vectors](../Unsorted/Witt%20Vectors.md).
...
- Grothendieck's [Descent](../Unsorted/descent.md): [faithfully flat](faithfully%20flat) implies something is an equivalence.
...
- The [Artin Map](../Unsorted/Artin%20Map.md) from [Class field theory](../Unsorted/Class%20field%20theory.md): $\Cl(K) \mapsvia{\sim} \Gal(H/K)$ where $\mfp \mapsto \Frob_{\mfp}$.
...
- Set $G_k \da \Gal(\Qbar/K)$, then $\Cl(K)$ is a quotient of $G_k^{\Ab}$.
  ...
  - Equivalently, $\Cl(K)\dual \leq G_k\dual$ where $(\wait)\dual \da \Hom_{\Top\Grp}(\wait, \CC\units)$.
  	I.e. take continuous [../Unsorted/characters](../Unsorted/characters.md).
...
- [Kummer](Kummer%20theory) proved FLT for exponent $p$ for **regular** primes, i.e. $\gcd(h_K, p) = 1$.
  - Kummer's criterion: $p$ is regular iff $p$ divides none of the numerators of some [../Unsorted/Bernoulli numbers](../Unsorted/Bernoulli%20numbers.md).

- What is the [Teichmüller character](Teichmüller%20character)?

- [../Unsorted/Birch and Swinnerton-Dyer conjecture](../Unsorted/Birch%20and%20Swinnerton-Dyer%20conjecture.md): define the [Tate-Shafarevich group](Tate-Shafarevich%20group) as $\Sha(E/\QQ)$ for an [Elliptic curve](../Unsorted/elliptic%20curve.md), then
\[
