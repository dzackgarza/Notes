...
:::{.remark}
This is a specialized notion of a [Kan complex](Kan%20complex.md), and in particular all [infinity categories](infinity%20categories.md) are Kan complexes.
...
In good situations, we have even more: the space of such choices will be [contractible](contractible%20choice.md), which is stronger than there just being a homotopy between any two choices.
...
Looking at Kan complexes also yields $\infty\dash$categories where all of the morphisms are invertible, so these are in fact [infinity groupoids](infinity%20groupoids.md).
