...
![Visual indication of continuity](../figures/figures%201/TopologicalFixedPointTheorems-fa1fa.png)
...
![Here's an example of something halfway between a sphere and a cube](../figures/figures%201/TopologicalFixedPointTheorems-045d7.png)



![Spheres and Discs](../figures/figures%201/TopologicalFixedPointTheorems-55c1f.png)
...
![Definition of $g: D^2 \to S^1$](../figures/figures%201/TopologicalFixedPointTheorems-7bba3.png)
...
![Band of continuous stuff](../figures/figures%201/TopologicalFixedPointTheorems-b44b2.png)
...
![Path taken by temperature changes](../figures/figures%201/TopologicalFixedPointTheorems-e539d.png)
...
# What is a fixed point?
  ...
  - Geometrically, several equivalent ways to think about it\
    ...
    Draw $f(x) = \cos(x)$
    ![](../figures/figures%201/TopologicalFixedPointTheoremsOutline-301a4.png)
    - Equivalently, draw graph of $g(x) \definedas f(x) - x$ and find a zero.
    Draw $g(x) = \cos(x) - x$:
    ![](../figures/figures%201/TopologicalFixedPointTheoremsOutline-49008.png)

    - Okay, but what about $\RR^n \selfmap_f$? Now we need a different model, think of this as a _deformation_ of the space:
    ![Deformation](../figures/figures%201/TopologicalFixedPointTheoremsOutline-bdd5e.png)
...
- Less dumb example: $\RR \mapsvia{x \mapsto ax + b}\RR \implies F = \emptyset$ (as long as $b\neq 0$)
  ...
  ![Affine Transformation](../figures/figures%201/TopologicalFixedPointTheoremsOutline-616d1.png)

- Moderate example: $\RR^2 \mapsvia{(x,y) \mapsto (y, x)} \implies F = \theset{y=x}$
Just swapping coordinates, look at a few:
![](../figures/figures%201/TopologicalFixedPointTheoremsOutline-081c0.png)
