...
## Hopf Invariant 1
A reason to care about cohomology theories: Adams' two solutions to the [[Hopf invariant one]] problem. First solution uses ordinary cohomology to do the work, but long and uses higher [Cohomology operations](Cohomology%20operations.md). 
