...
- *Formal schemes*: topologically ringed spaces $(X, \OO_X)$ where $\OO_X$ is a sheaf of topological rings covered 
  - *Formal spectrum*: $\Spf R \da \Spf_I R = \colim_{n} \Spec R/I^n$, where $I^n$ is a system of ideals forming neighborhoods of zero? Take the colimit in $\Top\Ringedspace$.
