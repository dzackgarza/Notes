...
:::{.definition title="Cone points and cone angles"}
...
:::{.remark}
There is a weird phenomenon: it seems difficult to find $\ZZ^2$ or $\QQ^2$ points on the sloped edges of a regular polygon, based on computer drawings.
:::
...
:::{.definition title="Translation surface (updated)"}
...
:::{.definition title="Holomorphic 1-forms"}
