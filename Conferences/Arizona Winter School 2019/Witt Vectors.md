...
and so another choice of $a_i$ can be found by looking at $U \definedas theset{(p-1)$st roots of unity in $\ZZ_p$, i.e. the roots of $x^p - x$, and alternatively take $a_i \in U \union \theset{0}$. 
