...
Fix $K3$ surfaces of a given degree, there is a 19-dimensional moduli space where Bott vanishing holds. (May need to throw away countably many subspaces, remaining "very general")