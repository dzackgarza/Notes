...
Generalization of Kodaira vanishing; holds for all smooth projective **toric** varieties. Projective space has an interesting endomorphism, essentially the frobenius ($p^{\text{th}0}$ power map $\vector{x_1, x_2}]$)