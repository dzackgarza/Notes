...
Generalization of Kodaira vanishing; holds for all smooth projective **toric** varieties. Projective space has an interesting endomorphism, essentially the frobenius ($p^{\text{th}0}$ power map $\thevector{x_1, x_2, \cdots} \mapsto \thevector{x_1^p, x_2^p, \cdots}$