...
# Further Notes
On spaces $\RR^3 - X$:
>My personal crutch is to just think about complements in S3, which are usually easier since knot complements in S3 are always K(π,1)s. Now if K is a knot and X is its complement in S3, then you can prove that its complement in R3 is homotopy equivalent to $S2\vee X$
